<section class="h-[400px] relative">
    <img src="{{ asset('assets/images/hero.jpg') }}" alt="myLoker" class="absolute w-full h-full object-cover -z-10 brightness-50">
    <div class="h-full flex flex-col place-content-center text-center text-white">
        <h1 class="font-bold text-5xl">PELUANG TAK TERBATAS, CARI LOWONGAN DI myLoker.</h1><br>
        <p class="text-2xl">myLoker | Karena Pekerjaan Impianmu Ada Di Sini</p>

        <!-- Sign Up Form -->
        <div class="w-[600px] mx-auto mt-10 relative">
