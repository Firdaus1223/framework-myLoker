<div class="w-[400px] bg-blue-800 ">
    <div class="h-screen p-8 flex flex-col justify-between bg-blue-800">
        <img src="{{ asset('assets/images/logo-informatika-white.png') }}" alt="" class="w-16">
        <div>
            <a href="{{ route('admin.dashboard') }}" class="flex gap-4 items-center p-4 rounded-md hover:bg-blue-700  transition ease-out duration-150">
            ...
            <a href="{{ route('admin.pekerjaan') }}" class="flex gap-4 items-center p-4 rounded-md hover:bg-blue-700  transition ease-out duration-150">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" class="w-8 h-8 fill-white">
            ...
            <a href="{{ route('admin.pelamar') }}" class="flex gap-4 items-center p-4 rounded-md hover:bg-blue-700  transition ease-out duration-150">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" class="w-8 h-8 fill-white">
                    <path d="M242-249q-20-11-31-29.5T200-320v-192l-96-53q-11-6-16-15t-5-20q0-11 5-20t16-15l338-184q9-5 18.5-7.5T480-829q10 0 19.5 2.5T518-819l381 208q10 5 15.5 14.5T920-576v256q0 17-11.5 28.5T880-280q-17 0-28.5-11.5T840-320v-236l-80 44v192q0 23-11 41.5T718-249L518-141q-9 5-18.5 7.5T480-131q-10 0-19.5-2.5T442-141L242-249Zm238-203 274-148-274-148-274 148 274 148Zm0 241 200-108v-151l-161 89q-9 5-19 7.5t-20 2.5q-10 0-20-2.5t-19-7.5l-161-89v151l200 108Zm0-241Zm0 121Zm0 0Z"/></svg>
                <p class="text-xl font-medium text-white">Pelamar</p>
            </a>
            <a href="{{ route('admin.pesan') }}" class="flex gap-4 items-center p-4 rounded-md hover:bg-blue-700  transition ease-out duration-150">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" class="w-8 h-8 fill-white">
